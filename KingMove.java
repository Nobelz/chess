 ...
 */
public interface KingMove extends NormalMove, CheckMove {
    /**
     ...
     * @since 1.0
     */
    public default boolean isValidKingNonCaptureMove(int row, int column, ChessPiece cp) {
     ...
     * @since 1.0
     */
    public default boolean isValidKingCaptureMove(int row, int column, ChessPiece cp) {
